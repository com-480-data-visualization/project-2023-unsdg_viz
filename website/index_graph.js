document.addEventListener("DOMContentLoaded", function () {
    ...
    const click_7 = (event, d) => {
        ...
        click7++;
        if (click7 % 2 === 1) {
            document.getElementById('id7').innerHTML = "<div id='id7', style='position:relative'> <img src='index_imgs/blanks/id7.png' style='width:100%; z-index=1'>  <div style='color:white; position:absolute; top: 0px; left: 10px; z-index=2; font-size: 80%;'> <ul> <li> Greenhousegas emissions, </li> <li> Population with primary reliance on clean fuels, </li> <li> Renewable energy share, </li> <li> CO2 emissions from fuel combustion, </li> <li> Fossil fuel subsidies cons. and prod. </li> </ul> </div> </div>";
        } else {
