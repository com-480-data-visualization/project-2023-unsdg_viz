document.addEventListener("DOMContentLoaded", function () {
    ...
    const click_3 = (event, d) => {
        ...
        click3++;
        if (click3 % 2 === 1) {
            document.getElementById('id3').innerHTML = "<div id='id3', style='position:relative'> <img src='index_imgs/blanks/id3.png' style='width:100%; z-index=1'>  <div style='color:white; position:absolute; top: 70px; left: 0px;z-index:2; font-size: 100%;'> <ul> <li>Mortality rate, </li> PM2.5 air pollution </li> </ul> </div> </div>";
        } else {
