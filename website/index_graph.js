document.addEventListener("DOMContentLoaded", function () {
    ...
    const click_1 = (event, d) => {
        ...
        click1++;
        if (click1 % 2 === 1) {
            document.getElementById('id1').innerHTML = "<div id='id1', style='position:relative'> <img src='index_imgs/blanks/id1.png' style='width:100%; z-index=1'>  <div style='color:white; position:absolute; bottom: 20px; right: 20px;z-index:2; font-size: 15%;'>   </div> </div>";
        } else {
    ...
    const click_2 = (event, d) => {
        ...
        click2++;
        if (click2 % 2 === 1) {
            document.getElementById('id2').innerHTML = "<div id='id2', style='position:relative'> <img src='index_imgs/blanks/id2.png' style='width:100%; z-index=1'>  <div style='color:white; position:absolute; bottom: 20px; right: 20px;z-index:2; font-size: 100%;'>  </div> </div>";
        } else {
    ...
    const click_3 = (event, d) => {
        ...
        click3++;
        if (click3 % 2 === 1) {
            document.getElementById('id3').innerHTML = "<div id='id3', style='position:relative'> <img src='index_imgs/blanks/id3.png' style='width:100%; z-index=1'>  <div style='color:white; position:absolute; top: 70px; left: 30px;z-index:2; font-size: 100%;'> <ul> <li>Mortality rate, </li> PM2.5 air pollution </li> </ul> </div> </div>";
        } else {
    ...
    const click_5 = (event, d) => {
        ...
        click5++;
        if (click5 % 2 === 1) {
            document.getElementById('id5').innerHTML = "<div id='id5', style='position:relative'> <img src='index_imgs/blanks/id5.png' style='width:100%; z-index=1'>  <div style='color:white; position:absolute; bottom: 20px; right: 20px;z-index:2; font-size: 100%;'>   </div> </div>";
        } else {
    ...
    const click_6 = (event, d) => {
        ...
        click6++;
        if (click6 % 2 === 1) {
            document.getElementById('id6').innerHTML = "<div id='id6', style='position:relative'> <img src='index_imgs/blanks/id6.png' style='width:100%; z-index=1'>  <div style='color:white; position:absolute; bottom: 20px; right: 20px;z-index:2; font-size: 100%;'>   </div> </div>";
        } else {
    ...
    const click_8 = (event, d) => {
        ...
        click8++;
        if (click8 % 2 === 1) {
            document.getElementById('id8').innerHTML = "<div id='id8', style='position:relative'> <img src='index_imgs/blanks/id8.png' style='width:100%; z-index=1'>  <div style='color:white; position:absolute; top: 50px; left: 30px;z-index:2; font-size: 100%;'> <ul> <li> Total government revenue proportion of gdp, </li> <li> Annual growth rate </li></ul> </div> </div>";
        } else {
    ...
    const click_10 = (event, d) => {
        ...
        click10++;
        if (click10 % 2 === 1) {
            document.getElementById('id10').innerHTML = "<div id='id10', style='position:relative'> <img src='index_imgs/blanks/id10.png' style='width:100%; z-index=1'>  <div style='color:white; position:absolute; bottom: 20px; right: 20px;z-index:2; font-size: 100%;'>  </div> </div>";
        } else {
    ...
    const click_11 = (event, d) => {
        ...
        click11++;
        if (click11 % 2 === 1) {
            document.getElementById('id11').innerHTML = "<div id='id11', style='position:relative'> <img src='index_imgs/blanks/id11.png' style='width:100%; z-index=1'>  <div style='color:white; position:absolute; bottom: 20px; right: 20px;z-index:2; font-size: 100%;'>   </div> </div>";
        } else {
    ...
    const click_12 = (event, d) => {
        ...
        click12++;
        if (click12 % 2 === 1) {
            document.getElementById('id12').innerHTML = "<div id='id12', style='position:relative'> <img src='index_imgs/blanks/id12.png' style='width:100%; z-index=1'>  <div style='color:white; position:absolute; bottom: 20px; right: 20px;z-index:2; font-size: 100%;'>  </div> </div>";
        } else {
    ...
    const click_13 = (event, d) => {
        ...
        click13++;
        if (click13 % 2 === 1) {
            document.getElementById('id13').innerHTML = "<div id='id13', style='position:relative'> <img src='index_imgs/blanks/id13.png' style='width:100%; z-index=1'>  <div style='color:white; position:absolute; top: 5px; left: 30px;z-index:2; font-size: 80%;'> <ul> <li>Number of companies publishing sustainability reports, </li> <li> Education for sustainable development, </li> <li> Enhance policy coherence for sustainable development, </li> <li> Land degraded over total land area </li> </ul> </div> </div>";
        } else {
    ...
    const click_14 = (event, d) => {
        ...
        click14++;
        if (click14 % 2 === 1) {
            document.getElementById('id14').innerHTML = "<div id='id14', style='position:relative'> <img src='index_imgs/blanks/id14.png' style='width:100%; z-index=1'>  <div style='color:white; position:absolute; bottom: 20px; right: 20px;z-index:2; font-size: 100%;'>  </div> </div>";
        } else {
    ...
    const click_15 = (event, d) => {
        ...
        click15++;
        if (click15 % 2 === 1) {
            document.getElementById('id15').innerHTML = "<div id='id15', style='position:relative'> <img src='index_imgs/blanks/id15.png' style='width:100%; z-index=1'>  <div style='color:white; position:absolute; bottom: 20px; right: 20px;z-index:2; font-size: 100%;'>  </div> </div>";
        } else {
